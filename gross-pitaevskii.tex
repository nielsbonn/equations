...
\begin{proof}[Proof of Lemma \ref{l:ap}]
  ...
  Observe that, by Lemmata \ref{l:kernels} and \ref{l:bt}, and Proposition
  \ref{p:energy}, there exists a constant $C$, uniform in $N$ and $t$, that
  depends only on $\| \varphi \|_{H^1}$ and $V$, such that
  \begin{equation} \label{c2}
    \begin{gathered}
      \| k_t \|_{L^2} \le C, \qquad \| \nabla_1 k_t \|_{L^2} \le C \sqrt{N},
      \qquad \| \nabla_1 k_t \overline{k_t} \|_{L^2} \le C. \\
      \| \nabla \varphi_t \|_{L^2}^2 + \| \nabla_1 p_t \|_{L^2}^2 \le C,
      \qquad \| \nabla_1 s_t \|_{L^2}^2 \le C N.
    \end{gathered}
  \end{equation}
  ...
  Combining this with \eqref{ep4} we obtain
  \begin{align*}
    ...
    \psi, (\N+1) \psi \rangle + \langle \psi, (\N+1)^2 \psi \rangle \big),
  \end{align*}
  for some constant $C_3$ that depends only on $\| k_t \|_{L^2}$. Finally, in
  view of \eqref{c2}, there exists a constant $C_4$, uniform in $N$ and $t$,
  that depends only on $\| \varphi \|_{H^1}$ and $V$, such that $C_3 < C_4$.
  This concludes the proof of part \ref{l:ap1}.
  ...
  \begin{align*}
    ...
    \big),
  \end{align*}
  for some constant $C_1$ as above.
  
  
  Therefore, combining the last two inequalities with \eqref{nk3},
  \begin{align*}
