...
\begin{prp} \label{p:lregn}
  ...
  \[
    ...
    \varphi_t
  \]
  with initial data $\varphi_0 = \varphi$. Then, there exist constants $T_n >
  0$ and $C_n$, which depend only on $\| V \|_{L^1}$, $\|
...
\begin{proof}
  ...
  \ref{c:reg1} and \ref{c:reg2} to estimate $\| \varphi_t^{(N)} \|_{H^1}$, $\|
