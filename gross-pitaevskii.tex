...
\underline{\Nestlist{12}{1}, \nestlist{12}{2} and \nestlist{13}{1}} can be estimated like \nestlist{11}{2}.\newline
...
& \leq C\norm{\ph}_{H^2}^2 \ev{\Ncal+1}.
\end{align*}
\underline{\Nestlist{18}{3} through \estlist{20}{3}:} like \nestlist{18}{2}.\newline
\estlist{21}{1}
\begin{align*}
...
This completes the list of estimates for the terms of $T^*_t \Lcal_N^{(0)}(t) T_t$.\newline
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{cor} \label{l:pdes} \label{c:reg1} \label{c:reg2}
  Let $\varphi \in H^n(\R^3)$ with $\| \varphi \|_{L^2} = 1$. Suppose that
  $f \in L^1(\R^3)$ and $V \in C_c^\infty(\R^3)$ with $fV \ge 0$. For $N \ge
  1$, consider a solution $\varphi_t^{(N)} \in H^1(\R^3)$ of the nonlinear
  Hartree equation
  \[
...
The initial value problem for the nonlinear Hartree equation
\[
...
\]
The exact same statement holds for the nonlinear
