...
\leq & C \dxyNV \norm{a(c_y)\psi}^2 \lvert\ph(y)\rvert^2 + C \dxyNV \norm{a(s_x)\psi}^2 \lvert \ph(x)\rvert^2 \\
& \qquad + \dxyV \norm{a(c_y)\psi}^2 \norm{p_y}^2 + \dxyV \norm{a(s_x)\psi}^2 \norm{s_x}^2 \\
\leq & \norm{\ph}_{H^2}^2 C(1+\frac{1}{N})\ev{\Ncal}.
\end{align*}
\estlist{18}{1}
...
\leq & \norm{\ph}_{H^2}^2 C \left( \ev{\Ncal} + \frac{1}{N}\ev{(\Ncal+2)^2} \right).
\end{align*}
\estlist{21}{2} like previous term
\begin{align*}
 & \lvert \scal{\psi}{\dxyNV \cc{\ph(y)} \frac{2}{\sqrt{N}}a^\ast(c_x) a^\ast(s_x) a(c_y)\psi } \rvert \\
\leq & \norm{\ph}_\infty^2 \int \di x\di y\, N V_N(x-y) \norm{a(c_x)\psi}^2 + \int \di x\di y\, NV_N(x-y) \frac{1}{N} \norm{a^\ast(s_x)a(c_y)\psi}^2 \\
\leq & \norm{\ph}_{H^2}^2 C \ev{\Ncal} + \frac{1}{N} \sup_x \norm{s_x}^2 \int \di x\di y\, NV_N(x-y) \norm{a(c_y)\Ncal^{1/2}\psi}^2 \\
\leq & \norm{\ph}_{H^2}^2 C \left( \ev{\Ncal} + \frac{1}{N}\ev{\Ncal^2} \right).
\end{align*}
...
\leq & \norm{\ph}_{H^2}^2 \frac{1}{\varepsilon}C\ev{\Ncal} + \varepsilon 4\ev{\tilV}.
\end{align*}
\estlist{22}{3}
\begin{align*}
...
\leq & \norm{\ph}_\infty^2 \int \di x\di y\, NV_N(x-y) \norm{a(s_x)\psi}^2 + \frac{1}{N} \int \di x \di y\, \norm{a(s_x)a(c_y)\psi}^2 \\
\leq & C \norm{\ph}_{H^2}^2 \ev{\Ncal} + \frac{1}{N}\sup_x \norm{s_x}^2 b_0 \int \di y\, \norm{a(c_y)\Ncal^{1/2}\psi}^2\\
...
\leq & \varepsilon 4 \ev{\tilV} + \norm{\ph}_{H^2}^2 \frac{1}{\varepsilon}C\ev{\Ncal+1}.
\end{align*}
\estlist{24}{1}
\begin{align*}
...
\leq & \norm{\ph}_{H^2}^2 C\frac{1}{\sqrt{N}}\ev{\Ncal+1}.
\end{align*}
\estlist{24}{2} like previous estimate
\begin{align*}
& \lvert \scal{\psi}{\dxyNV \frac{2}{\sqrt{N}}\cc{\ph(y)} a^\ast(s_y) \norm{s_x}^2 \psi}\rvert \\
...
\estlist{24}{3}
\begin{align*}
& \lvert \scal{\psi}{\dxyNV \frac{2}{\sqrt{N}}\cc{\ph(y)} a(c_y)\norm{s_x}^2\psi}\rvert \\
