...
\marginpar{Double sum inconsistent with single sum in other places.}
\[
...
\begin{lem}[Bogoliubov Transformation] \label{l:bt}
  ...
  \marginpar{Why $(x,y)$ in some places and not in others? Why we need to
  ...
  kernels, i.\,e.\ $fg(x,y) = \int dz \, f(x,z) g(z,y)$. Furthermore
  \marginpar{Why i.e. instead of that is?}
  \begin{alignat*}{2}
...
\scal{\psi}{\cdot\,\psi}$ in any state $\psi \in \fock$. \marginpar{This
remark about $C$ was already made in page 3.}Especially, $C$ stands for constants independent of $N$, $t$ and $\psi$. 
We define
\bd
...
\ee
\marginpar{I would change this sentence\dots}
...
\marginpar{I think this this lemma is not needed. Lemma 4.1 does the job.}
\begin{lem}
