...
\label{s:intro}
We consider a system of $N$ identical bosons with repulsive interaction. This system is described on the Hilbert space $L^2_s(\Rbb^{3N})$ of wave functions symmetric w.\,r.\,t.\ permutation of the $N$ variables by the Hamiltonian
\bd
