...
\begin{proof}[Proof of Proposition \ref{p:formulae}]
  Recall that $\phi(\varphi) = a(\varphi) + a^*(\varphi)$. After a short
  calculation, using parts (ii) and (iii) of Lemma \ref{l:W}, one easily finds
  (i), (ii) and (iii). Similarly, part (iv) follows by Lemma \ref{l:bt}.
\end{proof}
