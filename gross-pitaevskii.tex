...
\leq & C\norm{\ph}_{H^2}^2 \frac{1}{N}\ev{\Ncal^2}.
\end{align*}
\estlist{14}{1} \marginpar{this term could also be bounded by $\ev{\Ncal}$, if we distribute the $a^\ast$ equally to both arguments, I suppose}
\begin{align*}
...
\end{lem}
\begin{proof}
only terms which do not conserve the particle number appear here. estimates above, so proof is short.
\end{proof}
