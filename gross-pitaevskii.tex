...
\leq & C \norm{\ph}_{H^2} \left( \ev{\Ncal+1}(1+\frac{1}{\varepsilon}) + \varepsilon\ev{\Kcal} \right) + C \left( \frac{1}{\varepsilon}\ev{\Ncal+1} + \varepsilon \ev{\Kcal} \right).
\end{align*}
\estlist{8}{1}
\begin{align*}
...
\leq & C\norm{\ph}_{H^2} \frac{1}{N}\ev{\Ncal^2}.
\end{align*}
\estlist{13}{1}
\begin{align*}
...
\begin{prp}
  ...
  \begin{align}
    ...
    \langle \psi, T^* \K \N T \psi \rangle & \apprle |\langle \psi, T^* \K T
    \N \psi \rangle| + \langle \psi, \K \psi \rangle + (\| \nabla_1 p
...
\begin{proof}[Proof of Proposition \ref{p:TNT}]
  ...
  \end{align*}
  Now, by part (i),
  \marginpar{Is this correct? Is this a legal operation pointwise in $x$?}
  \begin{align*}
  ...
  \end{align*}
  Thus, combining these two expressions,
  \begin{equation}
    \label{ep5}
    ...
    T^* \K T \psi \rangle.
  \end{equation}
  Next, in order to estimate the first term in this inequality we write
  \begin{align*}
    & \int dx \, \langle T^* \nabla_x a_x T \psi, \N T^* \nabla_x a_x T \psi
    \rangle \\
  ...
  \begin{align*}
    ...
    \psi \rangle + \langle \psi, T \K T^* \rangle.
  \end{align*}
  Therefore, combining this with \eqref{ep5}, and using part (iii),
  \[
    \langle \psi, T^* \K \N T \psi \rangle \apprle |\langle \psi, T^* \K T \N
    \psi \rangle| + \langle \psi, \K \psi \rangle + (\| \nabla_1 p \|_{L^2}^2
    + \| \nabla_1 s \|_{L^2}^2) \langle \psi, (\N+1) \psi \rangle.
  \]
\end{proof}
