...
\begin{thm}[Evolution of Factorized States] \label{thm:main_factorized}
...
\ed
In the second-quantized setting we are going to work in it is more natural to consider the time evolution of squeezed coherent states instead of factorized states. For squeezed coherent states we obtain a better rate of convergence, see Theorem \ref{thm:main_squeezed}.
\end{enumerate}
\end{rems}
