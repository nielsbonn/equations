...
Suppose $V \in L^1 (\bR^3)$, with $|V(x)| \leq |x|^{-3-\eps}$ at infinity. Let $f$ denote the solution of the zero-energy scattering equation (\ref{eq:0en-0}), and $w = 1 - f$. Then there exists $c < 1$ with 
...
\end{lem}
A proof of Lemma \ref{lm:w} can be found in \cite{ESY2}, under the additional assumption that $V$ is compactly supported.
