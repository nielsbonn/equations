...
\begin{enumerate}
\item \label{k} There exists a constant $C$, depending only on\footnote{By Proposition \ref{t:pdes} this norm is uniformly bounded in $t$.} $\| \varphi^{(N)}_t \|_{H^1}$ such that
