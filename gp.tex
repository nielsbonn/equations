...
\begin{enumerate}
\item \label{k} There exists a constant $C$, depending only on $\| \varphi^{(N)}_t \|_{H^1}$\footnote{By Proposition \ref{t:pdes} this norm is uniformly bounded in $t$.} such that
