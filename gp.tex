...
& = A (f,g) + \int_0^1 d \lambda_1  \, e^{\lambda_1 B} [B,A (f,g)] e^{-\lambda_1 B}
 \end{split} \]
Iterating, we find
\begin{equation}\label{eq:baker} \begin{split} e^{B} A (f,g) e^{-B} = \; &A (f,g) + \sum_{j=1}^n \frac{1}{j!} \,\text{ad}_B^j (A (f,g)) \\ &+ \int_0^1 d\lambda_1 \int_0^{\lambda_1} d\lambda_2 \dots \int_0^{\lambda_{n}} d\lambda_{n+1} \, e^{\lambda_{n+1} B}  \text{ad}_B^{n+1} (A (f,g)) \, e^{-\lambda_{n+1} B}  \end{split}\end{equation}
